...
from .core.security_monitoring import log_security_event_api, get_security_events_api, security_dashboard, security_audit
...
urlpatterns = [
    ...
    path("security/log/", log_security_event_api, name="security-log"),
    path("security/events/", get_security_events_api, name="security-events"),
